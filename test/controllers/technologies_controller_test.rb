...
class TechnologiesControllerTest < ActionController::TestCase
  ...
  #     post :create, technology: { link: @technology.link, long_name: @technology.long_name, name: @technology.name }
  #   end
  #
  ...
  #   patch :update, id: @technology, technology: { link: @technology.link, long_name: @technology.long_name, name: @technology.name }
  #   assert_redirected_to technology_path(assigns(:technology))
  # end
  #
